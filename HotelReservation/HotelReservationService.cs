...
namespace HotelReservation
{
    public class HotelReservationService
    {
        ...
        public string getHighestRatedHotel(Customer customer, List<Hotel> hotels, string[] dates)
        {
            string output = "";
            double rateForBridgeWood = 0;
            double rateForRidgeWood = 0;
            ...
            if (customer.isRegular)
            {
                ...
                if (hotels[0].ratingOfHotel > hotels[1].ratingOfHotel && hotels[0].ratingOfHotel > hotels[2].ratingOfHotel)
                {
                    output = "Hotel: BridgeWood, Rate: " + rateForBridgeWood + ", Rating: " + hotels[0].ratingOfHotel;
                }
                if (hotels[1].ratingOfHotel > hotels[2].ratingOfHotel && hotels[1].ratingOfHotel > hotels[0].ratingOfHotel)
                {
                    output = "Hotel: RidgeWood, Rate: " + rateForRidgeWood + ", Rating: " + hotels[1].ratingOfHotel;
                }
                if (hotels[2].ratingOfHotel > hotels[0].ratingOfHotel && hotels[2].ratingOfHotel > hotels[1].ratingOfHotel)
                {
                    output = "Hotel: LakeWood, Rate: " + rateForLakeWood + ", Rating: " + hotels[2].ratingOfHotel;
                }
            }
            else
            {
